...
export type MessageAttachmentSummary = MessageAttachment;
export type MessageContentResponse = MessageContent;
export type MessageDetailResponse = MessageDetail;
