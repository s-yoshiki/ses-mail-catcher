...
This package is the TypeScript/jsii library in the repository's pnpm +
Turborepo monorepo. The mail relay, captured-message storage, and viewer will
be added incrementally while keeping the construct library compatible with the
AWS CDK ecosystem.
